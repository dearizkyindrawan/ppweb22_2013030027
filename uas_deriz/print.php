    ...
    <head>
       ...
       <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
        ...
        <div class="container">
            ...
            <a href="index.php"> <button class="btn btn-primary mb-2">Data</button></a>
            <button class="btn btn-success mb-2" id="cetak">Print Label</button>
            <select name="multi_search_filter" id="multi_search_filter" class="form-control" multiple>
            <?php
            include('koneksi.php');
            $query = $conn->query("SELECT barcode,nama FROM item ORDER BY id DESC");
